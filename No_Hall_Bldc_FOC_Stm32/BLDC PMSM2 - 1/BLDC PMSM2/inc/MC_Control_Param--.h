...
#define NTC_THRESHOLD_C				85		//°C on heatsink of MB459 board
...
#define PID_SPEED_REFERENCE_RPM   (s16)990
#define PID_SPEED_KP_DEFAULT      (s16)2200
#define PID_SPEED_KI_DEFAULT      (s16)1800
...
#define PID_TORQUE_REFERENCE   (s16)6747 //(N.b: that's the reference init
				//value in both torque and speed control)

#define PID_TORQUE_KP_DEFAULT  (s16)3004
#define PID_TORQUE_KI_DEFAULT  (s16)1600
#define PID_TORQUE_KD_DEFAULT  (s16)0

/* default values for Flux control loop */
#define PID_FLUX_REFERENCE   (s16)0
#define PID_FLUX_KP_DEFAULT  (s16)2304
#define PID_FLUX_KI_DEFAULT  (s16)3200
